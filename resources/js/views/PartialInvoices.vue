<template>
                  ...
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="filter">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                        ...
                        <li>
                            <router-link to="/partialinvoices/" custom v-slot="{ href, navigate, isActive }">
                            <a
                                :href="href"
                        ...
                        <li>
                            <router-link to="/lastmonthpartialinvoices" custom v-slot="{ href, navigate, isActive }">
                            <a
                                :href="href"
                                :class="{ active: isActive }"
                                class="dropdown-item"
                        ...
                        <li>
                            <router-link to="/lastninetypartialinvoices" custom v-slot="{ href, navigate, isActive }">
                            <a
                                :href="href"
                                :class="{ active: isActive }"
                                class="dropdown-item"
                        ...
                        <li>
                            <router-link to="/quarterpartialinvoices" custom v-slot="{ href, navigate, isActive }">
                            <a
                                :href="href"
                                :class="{ active: isActive }"
                                class="dropdown-item"
                        ...
                        <li>
                            <router-link to="/yearpartialinvoices" custom v-slot="{ href, navigate, isActive }">
                            <a
                                :href="href"
                                :class="{ active: isActive }"
                                class="dropdown-item"
                        ...
                        <li>
                            <router-link to="/lastyearpartialinvoices" custom v-slot="{ href, navigate, isActive }">
                            <a
                                :href="href"
                                :class="{ active: isActive }"
                                class="dropdown-item"
                        ...
                        <li>
                            <router-link to="/allpartialinvoices" custom v-slot="{ href, navigate, isActive }">
                            <a
                                :href="href"
                                :class="{ active: isActive }"
                                class="dropdown-item"
                      ...
                      <div class="card-body pb-0">
                        ...
                        <p class="card-text">
                          <div class="row">
                            <div class="col d-flex">
                              <button v-if="partialinvoices.length !== 0" class="me-2" @click="exportToExcel">Export</button>
                              ...
                              <router-link v-if="partialinvoices.length !== 0" to="#" custom v-slot="{ href, navigate, isActive }">
                                <a
                                  :href="href"
                                  :class="{ active: isActive }"
                                  class="btn btn-sm btn-primary rounded-pill me-2"
                                  style="background-color: darkorange; border-color: darkorange;"
                                >
                                  ({{ partialinvoices.length }}) Remaining
                                </a>
                              </router-link>
                            </div>
                            <div class="col-auto d-flex justify-content-end">
                              <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                  <a @click="navigateTo('/partialinvoices')" class="dropdown-item" href="#">
                        ...
                        <div>
                          <table id="AllStatementsTable" class="table table-borderless">
                            ...
                            <!-- Invoice rows -->
                            <tbody v-else>
                              <tr v-for="statement in partialinvoices" :key="statement.id">
                                <!-- Name -->
                                <td>
                                ...
                                <td>
                                  ...
                                  <span v-else-if="statement.status === 'partial'" class="badge bg-primary">
                                    <i class="bi bi-clipboard2-x"></i> Partial
                                  </span>
    ...
    export default {
      ...
      methods: {
        ...
        exportToExcel() {
          const invoicesData = this.partialinvoices.map(statement => ({
        ...
        generatePDF() {
           ...
           // Add title
            ...
            this.partialinvoices.forEach((statement, index) => {
        ...
        loadLists() {
          ...
          axios.get('api/lists')
            .then((response) => {
              this.partialinvoices = response.data.lists.partialinvoices;
        ...
        calculateTotal(property) {
          ...
          return this.partialinvoices.reduce((total, statement) => total + (statement[property] || 0), 0);
        },
      },
      components : {
        Master,
