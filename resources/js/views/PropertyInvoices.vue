                  ...
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="filter">
                      ...
                      <div class="card-body pb-0">
                        <h5 class="card-title">{{propertyTitle}} Invoices <span>| {{ awaitinginvoicing.length }} unpaid invoices</span></h5>
                        <p class="card-text">
                          <div class="row">
    ...
    export default {
      ...
      methods: {
        ...
        loadLists() {
          ...
          axios.get('api/property-invoices/'+ this.$route.params.id)
            .then((response) => {
              this.awaitinginvoicing = response.data.propertyinvoices;
              this.property = response.data.property;
