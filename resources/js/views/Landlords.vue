                ...
                <div class="col-12">
                  <div class="card top-selling overflow-auto">
                    ...
                    <div class="card-body pb-0">
                      <h5 class="card-title">Landlords <span>| Property owners of M-Keja</span></h5>
                      <p class="card-text">
                        <div class="row">
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-header">
                      <h5 class="modal-title">View Landlord Details</h5>
                    ...
                    <div class="modal-body" v-if="selectedLandlord">
                      ...
                      <div class="row g-3">
                        ...
                        <!-- PROPERTY DATA -->
                        <div class="col-md-6" v-if="selectedLandlord.property_count || selectedLandlord.property_count === 0">
                          <strong>Property Count:</strong> <br> {{ selectedLandlord.property_count }}
                        </div>

                        <div class="col-md-6" v-if="selectedLandlord.assigned_properties">
                          <strong>Assigned Properties:</strong> <br> {{ selectedLandlord.assigned_properties }}
                        </div>

                        <div class="col-md-6" v-if="selectedLandlord.skills">
